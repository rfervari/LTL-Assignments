...
\[
    \begin{array}{ll}
    \aformula,\aformulabis & ::= \theta \mid \neg\aformula \mid \aformula \vee \aformulabis \mid \Next\aformula \mid \Prev\aformula \mid \aformula \Until \aformulabis \mid \aformula\Since\aformulabis \mid \Assign{\avar}{\aterm} \mid \Assign{\avar}{\adatum},
    \end{array}
\]
where: $\theta$ is an atomic constraint, $\avar\in\VAR$, $\aterm$ is a term, and $\adatum\in\adomain$.  
